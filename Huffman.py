...
class Huffman:
    ...
    #Example width = 1, data = 'abcd'
    #result data = {'a', 'b', 'c', 'd'}
    #Example width = 4 data = 'abcdefgh'
    #result data = {'abcd', 'efgh'}
    #Compression results can be higher with a larger width
    ...
    def get_compression_ratio(self, encodedValue):
        ...
        return 1 - (len(encodedValue) / float((len(self.originaldata)*8)))
...
if __name__ == "__main__":
    ...
    data = test_encoding_decoded(open(test_data_5, "rb").read())
